      ...
      <div className='header-container'>
        <nav>
          ...
          {navigation.map((nav, index) => (
            <StyledNavItem href={nav.link} key={index} $isCurrentPath={router.pathname.includes(nav.link)}>
              <Text color={'primary'} typography={'title-xxl'}>
                {nav.title}
              </Text>
            </StyledNavItem>
          ))}
        </nav>
        <ul className='external-link-container' role={'list'}>
          <li>
            <Link href={BLOG_LINKS.github as string} target='_blank' passHref className='external-link'>
              <>
                {isDesktop && (
                  <div className='icon'>
                    <GoLinkExternal />
          ...
          <li>
            <Link href={BLOG_LINKS.resume as string} target='_blank' passHref className='external-link'>
              <>
                {isDesktop && (
                  <div className='icon'>
                    <GoLinkExternal />
